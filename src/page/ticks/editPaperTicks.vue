                ...
                <el-dialog title="编辑图片" size='small' :visible.sync="dialogVisible">
                 <el-row :gutter='20'>
                   <el-col :span='12' v-for='items in photoList' style='padding:20px'>
                    ...
                    <el-col :span='12' style='padding:20px' v-if='photoList.length==0'>
                        <div class="pic_tab" >
...
import {checkEmpty,checkNum ,jianDate,checkMoney,dateFormat} from'../../lib/tools.js'
	export default{
       data(){
       	return{
       		id:'',
