                         ...
                         <div class="col col-md-12 col-sm-12">
                            <div class="row"  style='border-bottom:solid 1px #ddd;padding:10px 0px;background-color:white;'>
                                 <div class="col col-md-12 col-sm-12" style='height:16px;'>
                                     ...
                                     <strong style='font-size:16px;padding-left:10px'>
                                      状态
                                    </strong>
                                 </span>
                                 </div>
                           ...
                           <div class="row" style='margin-top:20px;min-height:180px;'>
                             <div class="col col-md-6 col-sm-6 text-left" style='background-color:white;border-right:solid 10px #ddd'>
                           ...
                           <div class="row" style="background-color:white;padding:30px 0px;">
                             <div class="col col-md-12 col-sm-12">
 
                             <div class="row" style='min-height:200px;color:#5c5c5c;padding:10px 0px 0px 5px;' v-if='pageData.totalCount!=0' >
                                  <div class="col col-md-12 col-sm-12 text-left" >
                                     ...
                                     <div class="row" v-if='pageData.length!=0' v-for='items in pageData.result'>
                           ...
                           <div class="row" style='min-height:200px' v-else>
                                  <div class="col col-md-12 col-sm-12 text-center">
                                    ...
                                    <p style='font-size:16px;color:#a9abaf;font-weight:bolder'>暂无消息提醒</p>
                                  </div>
                               </div>
                             </div>
                        </div>
    ...
    methods: {
      ...
      getData(){
        ...
        this.$http.get("/dingtalk/brief/list?falg="+this.flag+'&pageSize=10').then(res=>{
          ...
          self.pageData=res.data.data.page;
          }
        })
      },
      toBrief(){
