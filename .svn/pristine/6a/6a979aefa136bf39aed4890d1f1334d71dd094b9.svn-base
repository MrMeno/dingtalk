					...
					<div class="col col-md-12 col-sm-12" style='background-color:#f5f7fb'>
						...
						<div class="row" style='padding:20px;'>
                            <table class='billTable'>
                            	<tr>
                                <td rowspan='3'><p>付</p><p>款</p><p>人</p></td>
                            		<td colspan='2' style='width:15%'>全称</td>
                            	...
                            	<tr>
                                  ...
                                  <table class='amonts'>
                                    ...
                                    <tr>
                                      <td v-for='items in divNum(data.billAmount)'>{{items}}</td>
                                    </tr>
                                </table>
                              </td>
                            	</tr>
...
<script>
	export default{
       ...
       methods:{
       	getData(){
       		let self=this;
       		this.$http.get('/dingtalk/bill/view/init/'+this.version+'/'+this.id)
       		.then(res=>{
       			console.log(res);
