        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col col-md-12 col-sm-12">
             ...
             <div class="row"  style='background-color:white;padding-top:30px 0px 100px 0px;font-size:20px;min-height:700px'>
...
<script>
  import { monthdayscalendar } from '../../lib/calindar.js'
  export default {
    name: 'kprlManage',
    data (){
      return {
        ...
        duration: 'half', // half: 半年期 whole: 一年期
        dueDateTip: [],
        activeName:'first'
      }
    },
