<template>
	<div class='container-fluid' style='height:100%'>
      ...
      <div class="col col-md-12 col-sm-12 text-left">
              ...
              <div class="row" style='background-color:white;min-height:700px'>
              		...
              		<div class="row" style='line-height:30px;padding-top:30px'>
              			<div class="col col-md-7 col-sm-7 col-md-offset-3 col-sm-offset-3">
              				<div class="row" style='padding:8px'>
              					...
              					<div class="col col-md-7 col-sm-7 text-left">
              						<el-input type='text' v-model="amouts" :autofocus="true" placeholder="请输入票面金额"></el-input>
              					</div>
              				...
              				<div class="row" style='padding:8px'>
              					<div class="col col-md-3 col-sm-3 text-right">
              					 ...
              					 <div class="col col-md-7 col-sm-7 text-left" v-if='!ishYear'>
              						<el-input type='text' v-model='days' placeholder="请输入调整天数"></el-input>
              					  </div> 
                          <div class="col col-md-4 col-sm-4 text-left" v-if='ishYear'>
              				...
              				<div class="row" style='padding:8px'>
              					...
              					<div class="col col-md-7 col-sm-7 text-left">
              						<el-input type='text' v-model='monthsBeni' placeholder="请输入月利率" @change='monthBnft()'></el-input>
              					</div>
              				...
              				<div class="row" style='padding:8px'>
              					...
              					<div class="col col-md-7 col-sm-7 text-left">
              						<el-input type='text' v-model='yearBeni' placeholder="请输入年利率" @change='yearBnft()'></el-input>
              					</div>
              					<div class="col col-md-2 col-sm-2 text-left">
              						              					</div>
              				</div>
              				<div class="row" style='padding:8px'>
              					...
              					<div class="col col-md-7 col-sm-7 text-left">
              						<el-input type='text' v-model='beni' placeholder="请输入扣息"></el-input>
              					</div>
              					<div class="col col-md-2 col-sm-2 text-left">
...
<script>
import {checkNum} from '../../lib/util.js'
	export default{
		name:'broad',
		data(){
			return {
    ...
    computed:{
       ...
       isDiff(){
        ...
        monthBnft(){//关联月/年利率
          this.yearBeni=this.monthsBeni*12/10;
        },
         yearBnft(){//关联月/年利率
          this.monthsBeni=this.yearBeni/12*10
        },
         decimal(num,v){
        ...
        isAbled(){
              ...
              var amountAble=(this.amouts=='');//总金额为空true
               console.log(amountAble)
              console.log(beniAble)
