<template>
				...
				<div class="row" style='padding:20px;color:#5c5c5c'>
					<div class="col col-md-12 col-sm-12" style='background-color:#f5f7fb'>
						...
						<div class="row" style='padding:10px'>
							...
							<div class="col col-md-3 col-sm-3 text-left">
								  出票日： <el-date-picker   v-model="draftDate" format='yyyy-MM-dd' style='width:60%' type="date" placeholder="选择日期"> </el-date-picker>
                             </div>
							<div class="col col-md-3 col-sm-3 text-left">
						...
						<div class="row" style='padding:10px'>
							<div class="col col-md-2 col-sm-2 text-left" style='word-break:keep-all;padding-top:5px'>
							 剩余期限：{{limitDays}}</el-input>天
							</div>
							<div class="col col-md-5 col-sm-5 text-left" style='word-break:keep-all;' >
							调整：<el-input v-model='adjustDays' style='width:12%;padding:3px'></el-input>天<span>
								（节假日顺延{{delayDays}}天）
							</span>
							</div>
                         ...
                         <el-option   v-for="item in billSourceList"  :key="item.value"  :label="item.label"      :value="item.value"></el-option> 
                            ...
                            <table class='billTable' v-if="billClassify=='1'||billClassify=='2'">
                            	...
                            	<tr>
                            		...
                            		<td colspan='4'>{{convertCurrencys(billAmount)}}</td>
                            ...
                            <table class='billTable' v-else>
                              ...
                              <tr>
                                <td colspan='2' style='padding:10px 0px'>出票金额</td>
                                <td colspan='4'>{{convertCurrencys(Number(listNum.join(''))/100)}}</td>
                                <td>
                                  <table class='amonts'>
                                    <tr>
                                      <td>亿</td>
        ...
        <div class="row">
          <div class="col col-md-12 col-sm-12">
                <el-dialog title="添加图片" size='small' :visible.sync="dialogVisible">
              <div class="row">
...
import {checkEmpty,checkNum ,jianDate,checkMoney} from'../../lib/tools.js'
	export default{
       data(){
       	return{
       		data:[],
       ...
       methods:{
          ...
          if(self.draftDate!=''){
            ...
            acceptorName:self.acceptorName,//承兑人名称
            acceptorAcct:self.acceptorAcct,//承兑人账号
            acceptorBank:self.acceptorBank,//承兑人开户行
        ...
        delPic(){
         ...
         var arr= this.photoList.remove(this.picIndex);
          this.$set(this.photoList,arr);
               this.$message({
          message: '图片删除成功',
          type: 'success'
        });
    ...
    confirmUpload(){
      let self=this;
         this.photoList=[{picType:'front',picUrl:self.frontUrl},
     ...
     console.log(this.$refs);
      if(type==1){
       ...
       valFormData ( data ) {
            ...
            var isPaper=self.billClassify=='3'||self.billClassify=='4';
            console.log(isPaper)
            // 票据来源
